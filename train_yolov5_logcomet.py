    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            for x, tag in zip(list(mloss[:-1]) + list(results) + lr, tags):
                experiment.log_metric('recall', x)
                experiment.log_metric('precision', x)
                experiment.log_metric('mAP_0.5', x)
                experiment.log_metric('mAP_0.5:0.95', x)
                experiment.log_metric('box_loss', x)
                experiment.log_metric('obj_loss', x)
                experiment.log_metric('cls_loss', x)
                if tb_writer:
